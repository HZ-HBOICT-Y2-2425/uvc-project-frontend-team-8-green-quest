<div class="flex flex-col min-h-screen">
    ...
    <section class="bg-green p-6 mx-4 mt-6 rounded-3xl">
        <details class="bg-beige p-4 mb-6 border-4 border-orange-red rounded-2xl cursor-pointer flex flex-col shadow-md">
            <summary class="text-xl font-bold">What is Green Quest?</summary>
            <div class="bg-beige p-6 mt-4 rounded-lg shadow-md text-base leading-relaxed text-black border-4 border-orange-red">
        ...
        <details class="bg-beige p-4 mb-6 border-4 border-orange-red rounded-2xl cursor-pointer flex flex-col shadow-md">
            <summary class="text-xl font-bold">How It Works?</summary>
            <div class="bg-beige p-6 mt-4 rounded-lg shadow-md text-base leading-relaxed text-black border-4 border-orange-red">
        ...
        <details class="bg-beige p-4 mb-6 border-4 border-orange-red rounded-2xl cursor-pointer flex flex-col shadow-md">
            <summary class="text-xl font-bold">FAQ Section</summary>
            <div class="bg-beige p-6 mt-4 rounded-lg shadow-md text-base leading-relaxed text-black border-4 border-orange-red">
                <dl class="space-y-4">
                    ...
                    <dt class="font-bold text-lg">Version number: </dt>
                    <dd class="ml-4 text-base leading-relaxed">Frontend: v2.0.0</dd>
                    <dd class="ml-4 text-base leading-relaxed">Backend: v2.0.0</dd>
                </dl>
            </div>
        </details>
    </section>
